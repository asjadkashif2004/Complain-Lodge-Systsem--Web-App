...
<style>
  ...
  .admin-theme {
    background:
      radial-gradient(70rem 70rem at 15% -40%, rgba(124, 58, 237, 0.25), transparent 70%),
      radial-gradient(60rem 60rem at 110% 0%, rgba(34, 211, 238, 0.18), transparent 70%),
  ...
  .btn-primary:hover {
    ...
    box-shadow: 0 16px 36px rgba(91, 140, 255, 0.5);
  }
  .btn-outline {
    ...
    <div class="row justify-content-center">
      <div class="col-xl-11">
        <div class="card-glass mb-4">
          ...
          <!-- Toolbar -->
          <div class="toolbar p-3 p-md-4 border-bottom border-0" style="border-color: rgba(255,255,255,.08)!important;">
